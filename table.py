...
class Lecture(UserMixin, db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    Subject = db.Column(db.String(10), unique=False, nullable=False, default="")
    Title = db.Column(db.String(100), unique=False, nullable=False, default="")
    Lecturer = db.Column(db.String(70), unique=False, nullable=False, default="")
    ...
    time = db.Column(db.String(50), unique=False, nullable=False, default="")
    like = db.Column(db.Integer, unique=False, nullable=False, default=0)
    def __init__(self, Subject, Title, Lecturer, time, Year, Month, Day, Location, Content, like):
...
class userToLec(UserMixin,db.Model):
    ...
    def __init__(self, userId, LecId):
        self.userId = userId
        self.LecId = LecId
...
# 收藏关系
class userToLecLike(UserMixin,db.Model):
    __tablename__ = 'UserToLecLike'
    id = db.Column(db.Integer, primary_key=True)
    userId = db.Column(db.Integer, unique=False, nullable=False, default=0)
    LecId = db.Column(db.Integer, unique=False, nullable=False,default=0)
